...
const ModuleCustomHead = () => (
    <Head>
        <title>MyMedi - React Ecomerce Template with RESTFul API</title>
        ...
        <script async src="https://pagead2.googlesyndication.com/pagead/js/adsbygoogle.js?client=ca-pub-2981858366603794"
